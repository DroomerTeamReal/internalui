...
do
	...
	function utils:Notify(text: string)
		cloneref(game:GetService("StarterGui")):SetCore("SendNotification", {
			Title = "RatSploit" .. (isiosdevice() and "" or ""),
			Text = text
		});
	end
...
do
	...
	local function createNavbar(gui: ScreenGui): Instance
		...
		local bar = instanceUtils:Create("Frame", {
			...
			},
			{
				...
				instanceUtils:Create("ImageLabel", { 
					...
					BackgroundTransparency = 1, 
					BorderSizePixel = 0, 
					Image = "rbxassetid://111597127409921", 
					Name = "codexIcon2", 
					Position = UDim2.new(0.5, 0 ,0.5, 0), 
					Size = UDim2.new(1,0,1,0),
					ZIndex = 2
			...
			instanceUtils:Create("Frame", { 
				...
				instanceUtils:Create("TextLabel", { 
					...
					Text = "RatSploit " .. (isiosdevice() and "" or ""),
					TextColor3 = Color3.fromHex("ffffff"), 
					TextSize = 16, 
					TextTransparency = 1,
					TextXAlignment = Enum.TextXAlignment.Left, 
				...
				instanceUtils:Create("TextLabel", { 
					...
					Text = "RatSploit Powerded By Codex", 
		...
		bar.indent:GetPropertyChangedSignal("Value"):Connect(function()
			...
			navbar.bar.main.poweredBy.TextTransparency = 1 + (0.2 - percentage) * 0.8;
			for i, v in map do
